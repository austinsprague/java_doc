...
public class LinkedList<E> implements Serializable, List<E> {
    /**
	 * Private serial ID
	 */
    ...
    /**
     * returns E value at the given index in the list
     */
    ...
    /**
     * pre: 0 less than or equals index less than or equals size() (throws IndexOutOfBoundsException if not)
    ...
    /**
     * pre : 0 less than or equals index less than size() (throws IndexOutOfBoundsException if not)
    ...
    /**
     * pre : 0 less than or equals index less than size()
     ...
     * is closer.
     * @param index Integer of the index of the Node
     * @return ListNode E at Index
     */
     ...
     * @param index Integer of the index to check
     */
    ...
    private static class ListNode<E> implements Serializable{
         ...
         * @param data type E of data for the Node
         */
         ...
         * @param data type E of the data of the node
         * @param next ListNode E next that assigns the node.next
         * @param prev ListNode E prev that assigns the node.prev
         */
